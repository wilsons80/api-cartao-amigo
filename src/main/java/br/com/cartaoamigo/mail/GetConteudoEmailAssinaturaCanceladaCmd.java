...
public class GetConteudoEmailAssinaturaCanceladaCmd {
	...
	public StringBuilder getConteudoHtml(EmailTO emailTO) {
	    ...
	    sb.append("            </div>                                                                                                                    ");
	    sb.append("            <div>                                                                                                                     ");
	    sb.append("              <span>produto, você também não irá mais desfrutar do Clube Cartão</span>                                                ");
	    sb.append("            </div>                                                                                                                    ");
	    sb.append("            <div>                                                                                                                     ");
	    sb.append("              <span>Amigo, nosso clube de vantagens que oferece descontos exclusivos e muito mais.</span>                             ");
	    sb.append("            </div>                                                                                                                    ");
	    sb.append("            <br>                                                                                                                      ");
	    sb.append("            <div>                                                                                                                     ");
